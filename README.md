...
The certification documents are provided in the following files:
...
To maximize the utility of this work to the research community, we also publicly release a **representative subset of probes** used in DBdoctor. This includes the monitored database/kernel functions and the corresponding runtime variables collected by each probe.

These examples demonstrate how fine-grained metrics are collected and correlated to each SQL statement in practice and may serve as useful references for researchers and practitioners when building probe sets for their own DBMSs.

The probe examples are provided in:
- [**Probe Examples.pdf**](https://github.com/neighthorn/DBdoctor/blob/main/Probe%20Examples.pdf)
